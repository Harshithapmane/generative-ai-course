...
Personal notes from a self-paced course on generative AI, kept day by day as I work through it.

![Topic](https://img.shields.io/badge/topic-Generative%20AI-8A2BE2)
![Format](https://img.shields.io/badge/format-Markdown%20notes-informational)
...
Writing notes in a way that could be read by someone else is a good forcing function for actually understanding the material, not just skimming it. It also doubles as a running record of the course for future reference.

---
*A running notebook for a generative AI course — updated as it progresses.*
